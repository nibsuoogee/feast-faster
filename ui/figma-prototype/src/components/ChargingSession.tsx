...
type ChargingSessionProps = {
  ...
  onStartCharging?: (station: ChargingStation) => void | null; // New addition
};
...
export function ChargingSession({
  ...
  // Mock charging history
  // const chargingHistory: ChargingSessionType[] = [
  //   {
  //     id: '1',
  //     stationId: '1',
  ...
  //     endTime: new Date(Date.now() - 86400000 * 5 + 2700000),
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      restaurantOrders.forEach((order) => {
        ...
        // After 30 seconds, move from pending to preparing
        if (
        ...
        // After 60 seconds, move from preparing to ready
        else if (
    ...
    <div className="min-h-[calc(100vh-120px)] bg-gray-50">
      <Tabs defaultValue="active" className="w-full">
              ...
              <>
                <Card className="p-8 text-center">
                  ...
                  {/* <p className="text-gray-600 mb-6">
                    Find a charging station on the map to start
                    charging
                  </p>
        ...
        {isJourneyActive && plannedJourney && (
          <TabsContent value="journey" className="m-0">
            <div className="p-4 space-y-4">
              <Card className="p-4 bg-green-50 border-green-200">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    {/* <span>{plannedJourney.endLocation}</span> */}
                    <span>
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm mb-3">
                    ...
                    <div>
                      {/* Get charger type and reservation time */}
                    ...
                    <span>
                      {plannedJourney.totalDistance} km
                    </span>
                  </div> */}
                    <div className="flex justify-between">
                      {/* <span className="text-gray-600">
              ...
              {/* {plannedJourney.stops.filter(
                  (s) => s.isSelected || s.selectedRestaurantId,
                ).length === 0 ? (
                  <Card className="p-6 text-center">
                    <p className="text-gray-600">
                      No stops selected for this journey
                    </p>
                    <p className="text-sm text-gray-500 mt-2">
                      You didn't select any charging stops.
                      Drive safely!
                    </p>
                  </Card>
                ) : (
                  <div className="space-y-3">
                    {plannedJourney.stops
                      .filter(
                        (stop) =>
                          stop.isSelected ||
                        ...
                        <Card key={index} className="p-4">
                          ...
                          <div className="grid grid-cols-2 gap-3 text-sm mb-3">
                            ...
                            <div>
                              ...
                              <div>
                                {stop.estimatedArrivalTime.toLocaleTimeString(
                                  "en-US",
                                  {
                                    hour: "numeric",
                                    minute: "2-digit",
              ...
              {/* Change true/false to show/hide reservation update */}
              {true && (
                <Card className="p-4 bg-blue-50 border-blue-200">
                  <div className="flex items-start gap-2">
                    <Navigation className="w-5 h-5 text-blue-600 mt-0.5" />
        ...
        {/* <TabsContent value="history" className="m-0">
          <div className="p-4 space-y-3">
            <div className="flex items-center justify-between mb-2">
              ...
              <Badge variant="outline">
                {chargingHistory.length} sessions
              </Badge>
            </div>
                ...
                <Card key={session.id} className="p-4">
                  ...
                  <div className="grid grid-cols-3 gap-3 text-sm">
                    ...
                    <div>
                      ...
                      <div>${session.cost.toFixed(2)}</div>
                    </div>
                  </div>
                </Card>
              );
        ...
        {/* <Card className="p-4 bg-blue-50 border-blue-200 mt-4">
              <h4 className="mb-3">Total Statistics</h4>
