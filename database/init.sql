...
CREATE TABLE "orders" (
  ...
  "created_at" timestamptz NOT NULL DEFAULT (now() AT TIME ZONE 'UTC'),
  "customer_eta" timestamptz NOT NULL DEFAULT (now() AT TIME ZONE 'UTC'),
  "food_status" food_status NOT NULL DEFAULT 'pending',
  "start_cooking_time" timestamptz NOT NULL DEFAULT (now() AT TIME ZONE 'UTC')
);
...
CREATE TABLE "reservations" (
  ...
  "created_at" timestamptz NOT NULL DEFAULT (now() AT TIME ZONE 'UTC'),
  "reservation_start" timestamptz NOT NULL DEFAULT (now() AT TIME ZONE 'UTC'),
  "reservation_end" timestamptz NOT NULL DEFAULT (now() AT TIME ZONE 'UTC'),
  "time_of_payment" timestamptz DEFAULT null,
  "current_soc" int DEFAULT null,
  "cumulative_price_of_charge" float DEFAULT null,
  "cumulative_power" float DEFAULT null,
  "charge_start_time" timestamptz DEFAULT null
);
